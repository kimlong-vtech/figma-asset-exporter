export function FloatingAlert({ message, tone = 'info', onDismiss }) {
	const toneClasses = {
	...
	return (
		<div className="fixed left-1/2 top-4 z-[70] w-[calc(100%-24px)] max-w-sm -translate-x-1/2 animate-[float-in_180ms_ease-out]">
			<div className={`rounded-[14px] border px-3 py-2 shadow-[0_18px_44px_rgba(15,23,42,0.16)] backdrop-blur ${toneClasses[tone] || toneClasses.info}`}>
